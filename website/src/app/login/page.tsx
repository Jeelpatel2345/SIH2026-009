...
import { 
  ...
  Loader2, Sparkles, User, AlertCircle 
} from 'lucide-react';
          ...
          <div>
            ...
            {step === 'PHONE' ? (
              ...
              <div className="space-y-6">
                ...
                {/* Received OTP Banner for easy local/demo testing */}
                {receivedOtp && (
                  <div className="bg-amber-50 border border-amber-200 p-3 rounded-xl flex items-center justify-between text-xs text-amber-800">
                    <span>Generated Code: <b>{receivedOtp}</b></span>
                    <button
                      type="button"
                      onClick={() => {
                      ...
                      className="bg-amber-200 hover:bg-amber-300 font-bold px-2.5 py-1 rounded-lg text-[11px] text-emerald-950"
                    >
                      Auto-fill & Login
                    </button>
                  </div>
